          ...
          <div className="itemArea">
            ...
            <div className="hex iconContainer pointer" onClick={() => select('hex')}>
              ...
              <div>
                <h3>Hex</h3>
                <p>
                  <span>Converting value</span>
                  between Hex and text
                </p>
              </div>
            </div>
            ...
            <div className="url iconContainer pointer" onClick={() => select('url')}>
              <Image className="icons" src={URL} alt="URL icon" />
              <div>
                <h3>URL</h3>
                <p>
                  <span>Encode and decode</span>
            ...
            <div className="jwt iconContainer pointer" onClick={() => select('jwt')}>
              <Image className="icons" src={JWT} alt="JWT icon" />
              <div>
                <h3>JWT</h3>
                <p>
                  <span>Encode and decode</span>
            ...
            <div className="textCase iconContainer pointer" onClick={() => select('uppercase')}>
              <Image className="icons" src={UppercaseImage} alt="Uppercase icon" />
              <div>
                <h3>Uppercase</h3>
                <p>
                  <span>Uppercase or</span>
                  lowercase text snippets
                </p>
              </div>
            </div>
            <div className="whitespace iconContainer pointer" onClick={() => select('whitespace')}>
              <Image className="icons" src={WhitespaceImage} alt="Whitespace icon" />
              <div>
                <h3>Whitespace</h3>
                <p>
                  <span>Removes whitespace</span>
                  from text
                </p>
              </div>
            </div>
